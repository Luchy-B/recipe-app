...
class PublicRecipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create public_recipe' do
    assert_difference('PublicRecipe.count') do
      post public_recipes_url,
           params: { public_recipe: { cooking_time: @public_recipe.cooking_time,
                                      description: @public_recipe.description, name: @public_recipe.name,
                                      preparation_time: @public_recipe.preparation_time,
                                      public: @public_recipe.public } }
    end
  ...
  test 'should update public_recipe' do
    patch public_recipe_url(@public_recipe),
          params: { public_recipe: { cooking_time: @public_recipe.cooking_time,
                                     description: @public_recipe.description, name: @public_recipe.name,
                                     preparation_time: @public_recipe.preparation_time,
                                     public: @public_recipe.public } }
